...
final class Version20200328193113 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql(
            'CREATE TABLE transactions (id INT NOT NULL, debit_account_id INT NOT NULL, credit_account_id INT NOT NULL, date DATE NOT NULL, amount BIGINT NOT NULL, PRIMARY KEY(id))'
        );
        ...
        $this->addSql(
            'CREATE TABLE users (id INT NOT NULL, account_id INT NOT NULL, name VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, PRIMARY KEY(id))'
        );
        $this->addSql('CREATE UNIQUE INDEX UNIQ_1483A5E99B6B5FBA ON users (account_id)');
        $this->addSql(
            'ALTER TABLE transactions ADD CONSTRAINT FK_EAA81A4C204C4EAA FOREIGN KEY (debit_account_id) REFERENCES user_accounts (id) NOT DEFERRABLE INITIALLY IMMEDIATE'
        );
        $this->addSql(
            'ALTER TABLE transactions ADD CONSTRAINT FK_EAA81A4C6813E404 FOREIGN KEY (credit_account_id) REFERENCES user_accounts (id) NOT DEFERRABLE INITIALLY IMMEDIATE'
        );
        $this->addSql(
